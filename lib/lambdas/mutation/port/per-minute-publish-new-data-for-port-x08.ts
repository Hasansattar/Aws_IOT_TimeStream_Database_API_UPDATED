...
export class PerMinutePublishNewDataForPortX08Lambda  extends Construct {
  constructor(scope: Construct, id: string, api: GraphQLApi, db: TimestreamDatabase, role: LambdaRole) {
    super(scope, id);
     
    const perMinutePublishNewDataForPortX08Lambda = new lambda.Function(this, "perMinutePublishNewDataForPortX08Lambda", {
      runtime: lambda.Runtime.NODEJS_16_X,
      handler: "perMinutePublishNewDataForPort-x08.handler",
    ...
    const lambdaDsPerMinutePublishNewDataForPortX08Lambda= api.graphQLApi.addLambdaDataSource(
      "lambdaDsPerMinutePublishNewDataForPortX08Lambda",
      perMinutePublishNewDataForPortX08Lambda
    );
  
    // Resolver for Mutation to publish new data
    lambdaDsPerMinutePublishNewDataForPortX08Lambda.createResolver("createResolverMutationlambdaDsPerMinutePublishNewDataForPortX08", {
      typeName: "Mutation",
      fieldName: "publishNewDataForPortx08",
    ...
    perMinutePublishNewDataForPortX08Lambda.addPermission("EventBridgeInvoke", {
    ...
    new events.Rule(this, "rulePerMinutePublishNewDataForPortX08Lambda", {
      schedule: events.Schedule.rate(cdk.Duration.minutes(1)),
      targets: [new targets.LambdaFunction(perMinutePublishNewDataForPortX08Lambda)],
    });
