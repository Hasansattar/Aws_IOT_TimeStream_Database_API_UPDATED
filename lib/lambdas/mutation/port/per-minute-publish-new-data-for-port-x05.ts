...
export class PerMinutePublishNewDataForPortX05Lambda  extends Construct {
  constructor(scope: Construct, id: string, api: GraphQLApi, db: TimestreamDatabase, role: LambdaRole) {
    super(scope, id);
     
    const perMinutePublishNewDataForPortX05Lambda = new lambda.Function(this, "perMinutePublishNewDataForPortX05Lambda", {
      runtime: lambda.Runtime.NODEJS_16_X,
      handler: "perMinutePublishNewDataForPort-x05.handler",
    ...
    const lambdaDsPerMinutePublishNewDataForPortX05Lambda= api.graphQLApi.addLambdaDataSource(
      "lambdaDsPerMinutePublishNewDataForPortX05Lambda",
      perMinutePublishNewDataForPortX05Lambda
    );
  
    // Resolver for Mutation to publish new data
    lambdaDsPerMinutePublishNewDataForPortX05Lambda.createResolver("createResolverMutationlambdaDsPerMinutePublishNewDataForPortX05", {
      typeName: "Mutation",
      fieldName: "publishNewDataForPortx05",
    ...
    perMinutePublishNewDataForPortX05Lambda.addPermission("EventBridgeInvoke", {
    ...
    new events.Rule(this, "rulePerMinutePublishNewDataForPortX05Lambda", {
      schedule: events.Schedule.rate(cdk.Duration.minutes(1)),
      targets: [new targets.LambdaFunction(perMinutePublishNewDataForPortX05Lambda)],
    });
