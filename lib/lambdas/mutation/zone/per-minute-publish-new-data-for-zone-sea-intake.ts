...
export class PerMinutePublishNewDataForZoneSeaIntakeLambda extends Construct {
  constructor(scope: Construct, id: string, api: GraphQLApi, db: TimestreamDatabase, role: LambdaRole) {
    super(scope, id);
     

    const perMinutePublishNewDataForZoneSeaIntakeLambda = new lambda.Function(this, "perMinutePublishNewDataForZoneSeaIntakeLambda", {
      runtime: lambda.Runtime.NODEJS_16_X,
      handler: "perMinutePublishNewDataForZoneSeaIntake.handler",
    ...
    const lambdaDsPerMinutePublishNewDataForZoneSeaIntakeLambda= api.graphQLApi.addLambdaDataSource(
      "lambdaDsPerMinutePublishNewDataForZoneSeaIntakeLambda",
      perMinutePublishNewDataForZoneSeaIntakeLambda
    );
  
    // Resolver for Mutation to publish new data
    lambdaDsPerMinutePublishNewDataForZoneSeaIntakeLambda.createResolver("createResolverMutationlambdaDsPerMinutePublishNewDataForZoneSeaIntake", {
      typeName: "Mutation",
      fieldName: "publishNewDataForZoneSeaIntake",
    ...
    perMinutePublishNewDataForZoneSeaIntakeLambda.addPermission("EventBridgeInvoke", {
    ...
    new events.Rule(this, "rulePerMinutePublishNewDataForZoneSeaIntakeLambda", {
      schedule: events.Schedule.rate(cdk.Duration.minutes(1)),
      targets: [new targets.LambdaFunction(perMinutePublishNewDataForZoneSeaIntakeLambda)],
    });
