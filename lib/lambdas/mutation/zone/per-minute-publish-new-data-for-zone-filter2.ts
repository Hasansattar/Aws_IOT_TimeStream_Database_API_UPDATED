...
export class PerMinutePublishNewDataForZoneFilter2Lambda extends Construct {
  constructor(scope: Construct, id: string, api: GraphQLApi, db: TimestreamDatabase, role: LambdaRole) {
    super(scope, id);
     
    const perMinutePublishNewDataForZoneFilter2Lambda = new lambda.Function(this, "perMinutePublishNewDataForZoneFilter2Lambda", {
      runtime: lambda.Runtime.NODEJS_16_X,
      handler: "perMinutePublishNewDataForZoneFilter2.handler",
    ...
    const lambdaDsPerMinutePublishNewDataForZoneFilter2Lambda= api.graphQLApi.addLambdaDataSource(
      "lambdaDsPerMinutePublishNewDataForZoneFilter2Lambda",
      perMinutePublishNewDataForZoneFilter2Lambda
    );
  
    // Resolver for Mutation to publish new data
    lambdaDsPerMinutePublishNewDataForZoneFilter2Lambda.createResolver("createResolverMutationlambdaDsPerMinutePublishNewDataForZoneFilter2", {
      typeName: "Mutation",
      fieldName: "publishNewDataForZoneFilter2",
    ...
    perMinutePublishNewDataForZoneFilter2Lambda.addPermission("EventBridgeInvoke", {
    ...
    new events.Rule(this, "rulePerMinutePublishNewDataForZoneFilter2Lambda", {
      schedule: events.Schedule.rate(cdk.Duration.minutes(1)),
      targets: [new targets.LambdaFunction(perMinutePublishNewDataForZoneFilter2Lambda)],
    });
